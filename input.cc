...
bool Input::editing() const { return editing_; }

std::string Input::get_string() const { return string_; }
...
void Input::text_input(const std::string& text) { string_ = text; }
...
const std::unordered_map<int, std::pair<Input::Button, Input::Button>>
    Input::kDefaultAxisBinds = {
