...
const std::unordered_map<int, Input::Button> Input::kDefaultKeyBinds = {
  ...
  { SDL_SCANCODE_KP_2,    Input::Button::A },
  { SDL_SCANCODE_KP_1,    Input::Button::B },
  { SDL_SCANCODE_KP_5,    Input::Button::X },
  { SDL_SCANCODE_KP_4,    Input::Button::Y },
...
const std::unordered_map<int, Input::Button> Input::kDefaultPadBinds = {
  ...
  { SDL_CONTROLLER_BUTTON_A,             Input::Button::B },
  { SDL_CONTROLLER_BUTTON_B,             Input::Button::A },
  { SDL_CONTROLLER_BUTTON_X,             Input::Button::Y },
  { SDL_CONTROLLER_BUTTON_Y,             Input::Button::X },
...
const std::vector<std::string> Input::kGamepadDB = {
  // Windows (mingw?)
  ...
  "571d2100000000000000504944564944,Tomee NES Adapter,a:b1,b:b0,back:b2,start:b3,dpup:-a1,dpdown:+a1,dpleft:-a0,dpright:+a0",
  ...
  "c82d21ab000000000000504944564944,SFC30 Joystick,a:b1,b:b0,x:b4,y:b3,back:b10,start:b11,leftshoulder:b6,rightshoulder:b7,leftx:a0,lefty:a1",
  "cfab0800000000000000504944564944,ABCF Nintender,a:b2,b:b0,x:b3,y:b1,back:b4,start:b5,leftshoulder:b6,rightshoulder:b7,leftx:a0,lefty:a1",
  ...
  "030000004c0500006802000011810000,Sony PLAYSTATION(R)3 Controller,a:b0,b:b1,x:b3,y:b2,back:b8,guide:b10,start:b9,leftstick:b11,rightstick:b12,leftshoulder:b4,rightshoulder:b5,dpup:b13,dpdown:b14,dpleft:b15,dpright:b16,leftx:a0,lefty:a1,rightx:a3,righty:a4,lefttrigger:a2,righttrigger:a5",
  ...
  "03000000571d00002100000010010000,Tomee NES Adapter,a:b1,b:b0,back:b2,start:b3,dpup:-a1,dpdown:+a1,dpleft:-a0,dpright:+a0",
  ...
  "03000000c82d000021ab000010010000,SFC30 Joystick,a:b1,b:b0,x:b4,y:b3,back:b10,start:b11,leftshoulder:b6,rightshoulder:b7,dpup:-a1,dpdown:+a1,dpleft:-a0,dpright:+a0",
  ...
  "03000000cfab00000800000011010000,ABCF Nintender,a:b2,b:b0,x:b3,y:b1,back:b4,start:b5,leftshoulder:b6,rightshoulder:b7,leftx:a0,lefty:a1",
